  ...
  function postBooking(e) {
    ...
    api.post(
      "/v1/bookings",
      {
        ...
        startDate: JSON.parse(localStorage.getItem("@inicial_date")).calendarDate,
      ...
      .catch(function (error) {
        Swal.fire({
          position: 'center',
          icon: 'error',
          title: 'Reserva falhou, tente novamente ou entre em contato com nosso Sac.',
          showConfirmButton: false,
          timer: 3000
        })
      });
              ...
              <div className="reserv_page_time_all">
                <div className="reserv_page_time">
                  ...
                  <div className="container__select_hour">
                    <p className="select_hour_text">Indique a sua hora prevista de retirada</p>
                    <div>
                      <select
            ...
            <div className="reserv_page_right">
              ...
              <div className="reserv_page_date">
                <div className="reserv_page_date_check">
                  <p>Check in</p>
                  <p>
                    {dateValue[0] ? dateValue[0] : "__/__/____"}
                  </p>
                </div>
                <div className="reserv_page_date_check">
                  <p>Check out</p>
                  <p>
                    {dateValue[1] ? dateValue[1] : "__/__/____"}
                  </p>
                </div>
              </div>
